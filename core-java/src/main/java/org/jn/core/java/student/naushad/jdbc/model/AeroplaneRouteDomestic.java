...
public class AeroplaneRouteDomestic {
	...
	public String toString() {
		return "AeroplaneRouteDomestic [id=" + id + ", route_name=" + route_name + ", departure_date=" + departure_date
				+ ", arrival_date=" + arrival_date + ", departure_city=" + departure_city + ", departure_state="
				+ departure_state + ", arrival_city=" + arrival_city + ", arrival_state=" + arrival_state + ", country="
				+ country + "]";
	}
