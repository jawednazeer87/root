...
public class AttendeeDto{
	...
	public int getAttendeeDto_id() {
		return attendee_id;
	}

	public void setAttendeeDto_id(int attendee_id) {
	...
	public String toString() {
		return "AttendeeDto [attendee_id=" + attendee_id + ", first_name=" + first_name + ", last_name=" + last_name
	...
	public AttendeeDto(int attendee_id, String first_name, String last_name, long phn_no, String eamil, boolean vip) {
		super();
		this.attendee_id = attendee_id;
		this.first_name = first_name;
		this.last_name = last_name;
