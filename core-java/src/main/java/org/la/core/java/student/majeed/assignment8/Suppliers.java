...
public class Suppliers {	
	...
	private int supplierId,postalCode,customerId;
    private String companyName, contact_fName, contact_lName, contact_title, address1, address2, city, state, country, phone, fax, email,
            url, paymentMethods, discountType, typeGoods, notes, currentOrder, logo;
    private boolean discountAvailabe;
    ...
    public void setDiscountAvailabe(boolean discountAvailabe) {
