...
import org.la.core.java.student.arfaz.assignment_11_Inheritance.subclasse.Para22Sub;
...
/*		19.	Create a parent class having protected String reverse(String) method, override reverse method in child class
	...
	*/
public class Pare22Main {
	
	public static void main(String[] args) {
	   Pare22 p = new Para22Sub();
	 System.out.println(p.concat("he","is","Arfaz"));  
	}
