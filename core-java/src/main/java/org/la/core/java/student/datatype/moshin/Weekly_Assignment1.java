...
public class Weekly_Assignment1 {
...
//		36. wap to declare int spc = 32; and print its char value
				...
				int spc = 32;
				System.out.println("number as char: "+(char)spc);
				System.out.println("int value: "+ spc);
				System.out.println();
...
//		39. wap to declare 3 double variables and assign any value and print it
		double bg=5.2,bh=4.2,bi=2.2;
		System.out.println(bg+bh);
		System.out.println(bh+bi);
		System.out.println(bi+bg);
		System.out.println();
		
//		40. wap to declare 3 float variables and assign any value and print it
		float bj=1.254F,bk=3.452F,bl=8.4F;
...
//		41. wap to declare 3 long variables and assign any value and print it
		long bm=4587L,bn=2572L,bo=1594L;
...
//		42. wap to declare 3 boolean variables and assign any value and print it
		boolean ca=true,cb=false,cc=true;
...
//		49. wap declare 5 char variable and assign vowel and print it
		char cj='a',ck='e',cl='i',cm='o',cn='u';
		System.out.println(cj+ck+cl+cm+cn);
		System.out.println();
		
//		50. wap declare 2 boolean, 3 int and 1 long variable and assign value and print it
		boolean cs=true,ct=false;
		int co=879,cp=7584,cq=7845;
		long cr = 4588L;
