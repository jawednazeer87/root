...
public class EmployeeChild2 extends Employee {
	@Override
	protected void name() {
		System.out.println("EmployeeChild2 name method called");
	}
	@Override
	public void child() {
		System.out.println("child method in EmployeeChild2 called");
	}
}
