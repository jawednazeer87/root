...
<form action="/advance-java/user/add/elhadj" method="post" id="userForm" class="container mb-5">
	...
	<div class="form-group">
  	...
  	<a class="btn btn-dark mx-3" href="/advance-java/user/list/elhadj" role="button">Cancel</a>
</form> 
