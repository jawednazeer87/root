<%@ page import="org.ecom.elhadj.model.Employee"%>
...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<form action="/advance-java/employee/add/elhadj">
...
<div>
	<form action="/advance-java/employee/search/elhadj" class="form-inline">
		<div class="form-group mx-sm-3 mb-2 container">
			...
			if(!employeeList.isEmpty()){
				for(Employee employee : employeeList){
					%>
						<tr>
							<td>
								<a href="/advance-java/user/detail/elhadj?userId=<%= employee.getId() %>">
									<%= employee.getName() %>
								</a>
							</td>
							...
							<td>
								<div class="row">
									<div class="col-sm-3">
										<a href="/advance-java/employee/delete/elhadj?userId=<%= employee.getId() %>" 
											class="btn btn-danger">Delete</a>
									</div>
									<div class="col-sm-3">
										<a href="/advance-java/employee/update/elhadj?userId=<%= employee.getId() %>"
