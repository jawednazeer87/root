...
<div>
	<h2>
		...
		<a class="btn btn-link mx-3" href="/advance-java/employee/list/elhadj" role="button">Back</a>
	</h2>
</div>

<form action="/advance-java/employee/add/elhadj" method="post" id="employeeForm" class="container mb-5">
	...
	<div class="form-group">
  	...
  	<a class="btn btn-dark mx-3" href="/advance-java/employee/list/elhadj" role="button">Cancel</a>
</form> 
