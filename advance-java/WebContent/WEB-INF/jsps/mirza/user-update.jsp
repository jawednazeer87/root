...
<form action="/advance-java/user/update/mirza" method="post" class="container mb-5">
  ...
  <div class="form-group">
	...
	<div class="form-group">
  	...
  	<a class="btn btn-dark mx-3" href="/advance-java/user/list/mirza" role="button">Cancel</a>
</form> 
