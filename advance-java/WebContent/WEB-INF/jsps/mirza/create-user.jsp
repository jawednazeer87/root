...
<div>
	<h2>
		...
		<a class="btn btn-link mx-3" href="/advance-java/user/list/mirza" role="button">Back</a>
	</h2>
</div>
...
<form action="/advance-java/user/add/mirza" method="post" id="userForm" class="container mb-5">
	...
	<div class="form-group">
		...
		<small id="datepickerHelp" class="form-text text-muted">
			...
			<label style='
						display: <%= (boolean)request.getAttribute("dobValid") ? "none" : "block" %>;
						color: red;
	...
	<div class="form-group">
		...
		<label style='
						display: <%= (boolean)request.getAttribute("emailValid") ? "none" : "block" %>;
						color: red;
						font-family: "Lucida Console", "Courier New", monospace;
						';
						>
	...
	<div class="form-group">
      ...
      <select id="country" name="country" class="form-control" onchange="changeCountry();">
	    ...
	    <option value="yemen">China</option>
	    <option value="syria">Russia</option>
	    <option value="saudi">United Kingdom</option>
