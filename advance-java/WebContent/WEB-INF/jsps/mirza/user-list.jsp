...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<a class="btn btn-primary" href="/advance-java/user/add/mirza"
...
<div>
	<form action="/advance-java/user/search/mirza" class="form-inline">
...
<table class="table table-hover">
	...
	<tbody>
		...
		<tr>
			<td><a
				href="/advance-java/user/detail/mirza?userId=<%=user.getId()%>">
					<%=user.getFirstName()%>
			</a></td>
			<td><%=user.getEmail()%></td>
			...
			<td>
				<div class="row">
					<div class="col-sm-3">
						<a
							href="/advance-java/user/delete/mirza?userId=<%=user.getId()%>"
							class="btn btn-danger">Delete</a>
					</div>
					<div class="col-sm-3">
						<a
							href="/advance-java/user/update/mirza?userId=<%=user.getId()%>"
