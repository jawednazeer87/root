...
<html>
	...
	<body>
		...
		<div>
			<h2><a href="/advance-java/EmployeeTwo/list">Employee Two Detail</a></h2>
		</div>
		
		<h1>Add User</h1>
		<form action="/advance-java/EmployeeTwo/add" method="post">
		  ...
		  <input type="text" id="notice_period" name="notice_period"><br><br>
