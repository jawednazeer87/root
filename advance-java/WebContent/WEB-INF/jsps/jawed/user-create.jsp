...
<form action="/advance-java/jawed/user/add" method="post" id="userForm" class="container mb-5">
	...
	<div class="form-group">
		...
		<input type="text" name="dob" class="form-control" id="datepicker" aria-describedby="datepickerHelp" 
