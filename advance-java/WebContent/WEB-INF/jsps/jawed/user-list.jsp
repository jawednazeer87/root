...
<div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm">
				<a class="btn btn-primary" href="/advance-java/user/add/jawed"
...
<div>
	<form action="/advance-java/user/search/jawed" class="form-inline">
...
<table class="table table-hover">
	...
	<tbody>
		...
		<tr>
			<td><a
				href="/advance-java/user/detail/jawed?userId=<%=user.getId()%>">
					<%=user.getFirstName()%>
			</a></td>
			<td><%=user.getEmail()%></td>
			...
			<td>
				<div class="row">
					<div class="col-sm-3">
						<a
							href="/advance-java/user/delete/jawed?userId=<%=user.getId()%>"
							class="btn btn-danger">Delete</a>
					</div>
					<div class="col-sm-3">
						<a
							href="/advance-java/user/update/jawed?userId=<%=user.getId()%>"
