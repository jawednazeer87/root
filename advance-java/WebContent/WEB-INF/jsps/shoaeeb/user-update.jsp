e<%@page import="org.ecom.student.shoaeeb.model.User"%>
...
<form action="/advance-java/user/update/shoaeebUpdate" method="post" class="container mb-5">
  ...
  <div class="form-group">
	...
	<div class="form-group">
  	...
  	<a class="btn btn-dark mx-3" href="/advance-java/user/list/shoaeeb" role="button">Cancel</a>
</form> 
