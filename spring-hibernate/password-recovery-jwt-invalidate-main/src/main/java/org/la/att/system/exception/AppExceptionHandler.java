package org.la.att.system.exception;

import java.util.Date;

import javax.servlet.http.HttpServletRequest;

import org.la.att.system.model.ErrorMessage;
...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> invalidTokenException(Exception ex, WebRequest request, HttpServletRequest httpRequest) {
